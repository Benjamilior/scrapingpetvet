...
urls = {
    ...
    "40152452071585": "https://petvet.cl/products/calmer-30ml.js",
    ...
    "42361854394529": "https://petvet.cl/products/dermisolona-suspension-oral-30ml.js",
...
# Convertir resultados a la lista de valores
values = [[row['SKU'], competitor, "No Dispo", row['Price'], row["Available"]] for _, row in df.iterrows()]
